const services = [
    ...
    },
    {
      ...
      description: "Combining both frontend and backend development skills (MERN Stack).",
    },
    {
      id: 4,
      title: "Flutter Development",
      description: "Developing cross-platform application using flutter framework.",
    },
];

const Experiance = () => {
  return (
    <div className='bg-black text-white py-20' id='experiance'>
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            <h2 className='text-4xl font-bold text-center mb-12'>My Experiance</h2>
